 ...
 */
public class GujaratiFragment extends ChildFragment {
    ...
    protected String[] getMsgArray() {
        ...
        switch (from){
            ...
            case TAG_DIWALI:
                msgArray = mActivity.getResources().getStringArray(R.array.diwali_gujarati_message_list);
                break;

            case TAG_NEW_YEAR:
                msgArray = mActivity.getResources().getStringArray(R.array.new_year_gujarati_message_list);
                break;
